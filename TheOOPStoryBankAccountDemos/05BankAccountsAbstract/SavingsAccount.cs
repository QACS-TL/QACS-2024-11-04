...
namespace BankAccountsAbstract
{
    public class SavingsAccount : BankAccount
    {
        ...
        public SavingsAccount(string accountNumber, string accountHolderName, decimal balance = 0, decimal interestRate = 0.5M) : base(accountNumber, accountHolderName, balance)
        {
