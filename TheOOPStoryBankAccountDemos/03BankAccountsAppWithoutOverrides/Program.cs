...
namespace BankAccountsApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            CurrentAccount currentAccount2 = new CurrentAccount("98765432", "Fred Astaire", 100.00m, 100.00m);
            //Withdrawing a value that takes the balance below 0 but above overdraft limit
            ...
            //Withdrawing a value that takes the balance above overdraft limit
            bankAccount.WithdrawMoney(51.00m);
            ...
            accounts[3].WithdrawMoney(100);  //Calls Base Bank Account version - disappointing!
