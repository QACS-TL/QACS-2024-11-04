...
namespace BankAccountsAbstract
{
    public class CurrentAccount: BankAccount
    {
        ...
        public CurrentAccount(string accountNumber, string accountHolderName, decimal balance = 0, decimal overdraftLimit = 0): base(accountNumber, accountHolderName, balance)
        {
        ...
        {
            Console.WriteLine($"Here's a statemnt for {AccountHolderName} No: {AccountNumber}");
        }
    }
